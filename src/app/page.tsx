      ...
      <header className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            <Link
              href="/login"
              className="min-w-0 text-center text-xs text-stone-600 hover:text-stone-800 sm:text-sm"
            >
              Log in
            </Link>
            <Link
              href="/signup"
              className="min-w-0 rounded-full bg-stone-800 px-4 py-2 text-center text-xs text-white hover:bg-stone-900 sm:text-sm"
            >
              Get started
            </Link>
          </nav>
      ...
      <section className="container mx-auto flex flex-1 items-center px-6 py-20">
        <div className="mx-auto w-full max-w-6xl md:flex md:items-center md:justify-between md:gap-12">
          <div className="relative z-10 mt-8 md:mt-0 md:w-1/2">
            ...
            <ul className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3 md:grid-cols-3 md:gap-6">
